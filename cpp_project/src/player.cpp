...
void Player::_ready() {
    ...
    // godot::Array outer = {godot::Array()};
    // godot::Variant arrayVariant = outer[0];
    // arrayVariant.is_null();
    // if (arrayVariant.get_type() == godot::Variant::Type::ARRAY) {
    //     godot::Variant value = static_cast<godot::Array>(arrayVariant)[0];
    // }
}
